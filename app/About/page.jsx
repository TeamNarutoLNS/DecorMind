...
//           }}
//           className="bg-[#5f4339] text-white px-6 py-2 rounded-xl font-medium shadow hover:bg-[#402c25] transition-all"
//         >
...
const About = () => {
  return (
    <div className="min-h-screen bg-[#f5ebe0] flex flex-col items-center px-4 sm:px-6">
      ...
      <section
        id="features"
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-6xl w-full text-center py-12 sm:py-16 px-4"
      >
        {[
          {
            title: "✨ AI-Powered Suggestions",
